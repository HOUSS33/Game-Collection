...
let locations = [
    ...
    },
    {
        ...
        text: "You find a secret game. Pick a number above. Ten numbers will be randomly chosen between 0 and 10. It the number you choose matches one of the random numbers, you win!"
    }
];
...
function sellWeapon(){
    if (inventory.length > 1) {
        ...
        text.innerHTML = "You sold a&nbsp;" + currentWeapon +". In your inventory you have:" + inventory + ".";
    }
    else{
...
function pick(guess){
    ...
    text.innerHTML = "You pickeda&nbsp;" + guess + ".Here are the random numbers:\n"
    for (let i = 0; i < 10; i++){
